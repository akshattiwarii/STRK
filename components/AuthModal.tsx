...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4 backdrop-blur-md animate-in fade-in overflow-y-auto">
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-strk-border bg-[#0d0f18] p-6 shadow-2xl my-6">
        ...
        <div className="flex items-center justify-between border-b border-strk-border/60 pb-3 mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h2 className="text-lg font-black text-white">STRK Account System</h2>
              <p className="text-xs text-strk-textMuted">Private, secure personal accountability</p>
            </div>
          </div>
