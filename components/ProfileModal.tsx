...
export const ProfileModal: React.FC<ProfileModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4 backdrop-blur-md animate-in fade-in overflow-y-auto">
      <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-strk-border bg-[#0d0f18] p-6 shadow-2xl my-6">
        ...
        <div className="flex items-center justify-between border-b border-strk-border/60 pb-3 mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h2 className="text-lg font-black text-white">Hunter Profile & Settings</h2>
              <p className="text-xs text-strk-textMuted">Private profile management</p>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-purple-500/30 bg-gradient-to-r from-purple-950/30 to-[#121422] p-4 mb-4">
